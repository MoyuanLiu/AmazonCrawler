...
public class ClearXLSXStorageTask implements Task{
	protected String taskstatus = "undo";
	protected String taskid = "";
	protected String storagefilepath = "";
	protected String resultsheetname = "";
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ARE.init("etc/are.xml");
	}
	public ClearXLSXStorageTask() {
		taskid = "ClearXLSXStorageTask" + System.currentTimeMillis();
	}
	public ClearXLSXStorageTask(String filepath,String sheetname) {
		taskid = "ClearXLSXStorageTask" + System.currentTimeMillis();
		this.storagefilepath = filepath;
		this.resultsheetname = sheetname;
	}
	...
	public void taskmain() {
		...
		Sheet sheet = workbook.getSheet(this.resultsheetname); 
